            ...
            <div style={this.props.isDark === true ? bgDark : bgLight}>
                <Navbar collapseOnSelect expand="xs" style={this.props.isDark === true ? bgDark : bgLight} variant="dark" fixed="top" className="fixedTop-1">
                    ...
                    <Nav className="justify-content-end ml-auto">
                        <NavDropdown style={abs} className="position-absolute" title={"Привет, " + this.props.uname} id="basic-nav-dropdown">
                            <NavDropdown.Item onClick={this.logoutCall} style={this.props.isDark === true ? navButtonDark : navButtonLight}>Выйти</NavDropdown.Item>
                        </NavDropdown>
                    </Nav>
                </Navbar>
                        ...
                        <Nav className="nav-2 mx-auto">
                            ...
                            >
                                <Form.Group as={Col} lg="2" controlId="validationDate">
                                    <Button className="addtask-btn btn-block" variant="warning" onClick={() => this.toggleModal()}>+ Добавить задачу</Button>
                                </Form.Group>
                                <Form.Group as={Col} lg="4" controlId="validationFromDate">
                                <InputGroup>
                                    <InputGroup.Prepend>
                                        <InputGroup.Text id="inputGroupPrepend1">От</InputGroup.Text>
                                    </InputGroup.Prepend>
                                    <Form.Control
                                        type="date"
                                        name="fromDate"
                                    ...
                                    <Form.Control.Feedback type="invalid">
                                        Пожалуйста, выберите подходящую дату.
                                ...
                                <InputGroup>
                                    <InputGroup.Prepend>
                                        <InputGroup.Text id="inputGroupPrepend2">Дo</InputGroup.Text>
                                    </InputGroup.Prepend>
                                    <Form.Control
                                        type="date"
                                        name="toDate"
